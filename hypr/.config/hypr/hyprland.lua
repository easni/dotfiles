...
require("hyprland-modules.autostart")
...
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 6, bezier = "myBezier", style = "slidefadevert -100%" }) -- Slide special workspaces down from the top
